...
public class WaVillagerEntity extends GizmodModElements.ModElement {
	public static EntityType entity = null;
	public WaVillagerEntity(GizmodModElements instance) {
		super(instance, 10);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("wa_villager")
						.setRegistryName("wa_villager");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -10027162, new Item.Properties().group(OzItemGroup.tab))
				.setRegistryName("wa_villager_spawn_egg"));
	}
