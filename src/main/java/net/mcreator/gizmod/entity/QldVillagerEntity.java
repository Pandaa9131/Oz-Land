...
public class QldVillagerEntity extends GizmodModElements.ModElement {
	public static EntityType entity = null;
	public QldVillagerEntity(GizmodModElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("qld_villager")
						.setRegistryName("qld_villager");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -10027162, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("qld_villager_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("gizmod:textures/be9e17f7e5e7e088045f41b1285edeee93d42557.png");
				}
			};
