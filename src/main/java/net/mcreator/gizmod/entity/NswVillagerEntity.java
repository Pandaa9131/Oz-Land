...
public class NswVillagerEntity extends GizmodModElements.ModElement {
	public static EntityType entity = null;
	public NswVillagerEntity(GizmodModElements instance) {
		super(instance, 14);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("nsw_villager")
						.setRegistryName("nsw_villager");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -10027162, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("nsw_villager_spawn_egg"));
	}
