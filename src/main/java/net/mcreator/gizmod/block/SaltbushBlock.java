...
public class SaltbushBlock extends GizmodModElements.ModElement {
	@ObjectHolder("gizmod:saltbush")
	public static final Block block = null;
	public SaltbushBlock(GizmodModElements instance) {
		super(instance, 19);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("gizmod:wa")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
