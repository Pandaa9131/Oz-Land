...
import net.mcreator.gizmod.entity.WaVillagerEntity;
import net.mcreator.gizmod.GizmodModElements;

import com.google.common.collect.ImmutableList;

@GizmodModElements.ModElement.Tag
public class WaBiome extends GizmodModElements.ModElement {
	@ObjectHolder("gizmod:wa")
	public static final CustomBiome biome = null;
	public WaBiome(GizmodModElements instance) {
		super(instance, 3);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.1f).depth(0.1f).scale(0.1f).temperature(0.8f).precipitation(Biome.RainType.RAIN)
			...
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(WaVillagerEntity.entity, 20, 4, 4));
		}
