...
import net.mcreator.gizmod.entity.SaVillagerEntity;
import net.mcreator.gizmod.GizmodModElements;

import com.google.common.collect.ImmutableList;

@GizmodModElements.ModElement.Tag
public class SaBiome extends GizmodModElements.ModElement {
	@ObjectHolder("gizmod:sa")
	public static final CustomBiome biome = null;
	public SaBiome(GizmodModElements instance) {
		super(instance, 4);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(SaVillagerEntity.entity, 20, 4, 4));
		}
	}
}
